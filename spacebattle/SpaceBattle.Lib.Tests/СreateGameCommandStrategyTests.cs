...
namespace SpaceBattle.Lib.Tests
{
    public class СreateGameCommandStrategyTests
    {
        ...
        public void CreateGameCommandStrategyPositiveTest()
        {
            ...
            var injectCmd = new InjectCommand(mockCmd.Object);
            ...
            IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Game.Scope.New", (object[] args) => (object)"bubki").Execute();
            ...
            IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Game.Command.Inject",(object[] args) => injectCmd).Execute();
